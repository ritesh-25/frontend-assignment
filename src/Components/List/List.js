...
export default function List(props) {
  ...
  useEffect(() => {
    ...
    setCardCount(count); 
  }, [props.ticketDetails, props.groupValue, props.listTitle]);
                  ...
                  <>
                    <div className="list-icon">
                      <div className="card-profile">
                        ...
                        <div
                          className={
                            props.ticketDetails.find(
                              ticket => ticket.userObj.name === props.listTitle
                            )?.userObj?.available
                    ...
                    {
                      {
                        0: (
                          <div className="list-icon">
                            <img src={NoPriority} alt="No Priority Icon" />
                          </div>
                        ),
                        1: (
                          <div className="list-icon">
                            <img src={LowPriority} alt="Low Priority Icon" />
                          </div>
                        ),
                        2: (
                          <div className="list-icon">
                            <img src={MediumPriority} alt="Medium Priority Icon" />
                          </div>
                        ),
                        3: (
                          <div className="list-icon">
                            <img src={HighPriority} alt="High Priority Icon" />
                          </div>
                        ),
                        4: (
                          <div className="list-icon">
                            <img src={Urgent} alt="Urgent Icon" />
                          </div>
                        ),
                      }[props.listTitle]
                    }
              ...
              {
                {
                  ...
                  user: <div className="list-title">{props.listTitle}</div>,
                }[props.groupValue]
              }
            </div>
        ...
        <div className="list-card-items">
          {props.ticketDetails.map(ticket => {
            if (
              ...
              return <Card key={ticket.id} cardDetails={ticket} groupValue={props.groupValue} />;
            }
            return null;
          })}
        </div>
